...
public class Day_05_Test {
	...
	public void part1SampleInputProducesExpected() throws IOException {
		final var result = Day_05.part_01(readerFromString(sampleInput));
		assertThat(result, is(35L));
	}

	@Test
	public void part2SampleInputProducesExpected() throws IOException {
		final var result = Day_05.part_02(readerFromString(sampleInput));
		assertThat(result, is(46L));
	}
}
